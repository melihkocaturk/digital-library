...
public class BookDbUtil {
	...
	public List<Book> getBooks() throws Exception {
		...
		try {
			...
			while (myRs.next()) {
				...
				Book book = new Book(id, category_id, title, description, author);
	...
	public void addBook(Book theBook) throws Exception {
		...
		try {
			...
			String sql = "INSERT INTO books (category_id, title, description, author) values (?, ?, ?, ?)";
	...
	public Book getBook(int bookId) throws Exception {
		...
		try {
			...
			if (myRs.next()) {
				...
				theBook = new Book(id, category_id, title, description, author);
			}
			else {
	...
	public void updateBook(Book theBook) throws Exception {
		...
		try {
			...
			String sql = "UPDATE books "
						+ " SET category_id=?, title=?, description=?, author=?"
						+ " WHERE id=?";
